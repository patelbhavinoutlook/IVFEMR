-- FertyFlow EMR/HIS Database Schema
...
CREATE TABLE embryology_records (
    ...
    cycle_id UUID NOT NULL REFERENCES treatment_cycles(cycle_id) ON DELETE CASCADE,
    procedure_type VARCHAR(100), -- 'Egg_Retrieval', 'Fertilization', 'Embryo_Development', etc.
...
CREATE TABLE medications (
    ...
    unit_type VARCHAR(50), -- 'Tablet', 'Injection', 'Capsule', etc.
